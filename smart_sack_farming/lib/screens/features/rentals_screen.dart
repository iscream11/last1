...
class _RentalsScreenState extends State<RentalsScreen>
  ...
  final List<Equipment> _myEquipment = [];
  final List<Equipment> _availableEquipment = [
    Equipment(
      id: '1',
      name: 'Tractor',
      description: '50 HP Tractor with plow attachment',
      category: 'Tractor',
    ...
    Equipment(
      ...
      description: '5 HP Electric Irrigation Pump with motor',
      category: 'Pump',
    ...
    Equipment(
      ...
      description: 'Power sprayer for pesticide application',
      category: 'Sprayer',
    ...
    Equipment(
      id: '5',
      name: 'Rotavator',
      description: 'Soil preparation rotavator for tractor',
      category: 'Tiller',
  ...
  void _addEquipment(Equipment equipment) {
    setState(() {
      _myEquipment.add(equipment.copyWith(
        id: DateTime.now().millisecondsSinceEpoch.toString(),
        ownerId: 'current_farmer', // In real app, use actual user ID
        ownerName: 'Your Name', // In real app, use actual user name
        ownerPhone: '9876543215', // In real app, use actual user phone
      ));
    });
